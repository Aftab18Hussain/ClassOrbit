...
function  NavBar() {
  return (
    ...
    <div><img  className='img' src="./image/images_low1.png" ></img> </div>
   ...
   <NavLink to="/signin"  style={{ textDecoration: 'none' }}><button className="btn btn-warning letter fs-3 text-white bg-dark">Login</button></NavLink>
